...
public class Document extends Thing {
	...
	public void addSection(Model model, ws.biotea.ld2rdf.rdf.model.doco.Section section) {
	    ...
	    model.addStatement(stm); //doc hasPart section
	...
	public void addAppendix(Model model, ws.biotea.ld2rdf.rdf.model.doco.Appendix appendix) {
		Statement stm = model.createStatement(this, DCTERMS_HAS_PART, appendix);
	    model.addStatement(stm); //doc hasPart appendix
	    Statement inv = model.createStatement(appendix, DCTERMS_IS_PART_OF, this);
	    model.addStatement(inv); //appendix isPartOf doc
	}
	...
	public void addDCTitle(Model model, String title){
	    ...
	    Statement stm = model.createStatement(this, DCTERMS_TITLE, titleAsLiteral);
	...
	public void addDCDescription(Model model, String desc){
	    ...
	    Statement stm = model.createStatement(this, DCTERMS_DESCRIPTION, descAsLiteral);
	...
	public void addDCLicense(Model model, String uriString) {
		Node uriNode = model.createURI(uriString);
		Statement stm = model.createStatement(this, DCTERMS_LICENSE, uriNode);
	...
	public void addDCCreator(Model model, String creatorURI){
	    ...
	    Statement stm = model.createStatement(this, DCTERMS_CREATOR, uriNode);
	...
	public void addDCCreated(Model model, String date){
	    ...
	    Statement stm = model.createStatement(this, DCTERMS_CREATED, dateNode);
	    model.addStatement(stm); //name
	}
	...
	public void addDCIssued(Model model, String year){
		...
		//Node dateNode = new DatatypeLiteralImpl(year, XSD._date); 
	    Statement stm = model.createStatement(this, DCTERMS_ISSUED, dateNode);
	    model.addStatement(stm); //name
	}
	...
	public void addDCIsReferencedBy(Model model, String reference){   
		URI uri = model.createURI(reference);
	    Statement stm = model.createStatement(this, DCTERMS_IS_REFERENCED_BY, uri);
	    model.addStatement(stm); //name
	}
	...
	public void addSource(Model model, String uriString) {
		Node uriNode = model.createURI(uriString);
		Statement stm = model.createStatement(this, DCTERMS_SOURCE, uriNode);
	    model.addStatement(stm); //pmc
	}
	
	public void addIsFormatedVersionOf(Model model, String uriString) {
		Node uriNode = model.createURI(uriString);
		Statement stm = model.createStatement(this, DCTERMS_IS_FORMAT_OF, uriNode);
	    model.addStatement(stm); //doc is format of pmc
	    try {
		    Statement inv = model.createStatement(uriNode.asResource(), DCTERMS_HAS_FORMAT, this);
		    model.addStatement(inv); //pmc hasFormat doc
	    } catch (ClassCastException e) {System.out.println("CAST: " + e.getMessage()); } //TODO:quitar
	}
	
	public void addProvWasDerivedFrom(Model model, String uriString) {
		Node uriNode = model.createURI(uriString);
		Statement stm = model.createStatement(this, PROV_WASDERIVEDFROM, uriNode);
	    model.addStatement(stm); //pmc
	}
	
	public void addProvWasAttributedTo(Model model, String uriString) {
		Node uriNode = model.createURI(uriString);
		Statement stm = model.createStatement(this, PROV_WASATTRIBUTEDTO, uriNode);
	    model.addStatement(stm); //pmc
	}
	...
	public void addProvGeneratedAt(Model model, String date) {
		PlainLiteral dateNode = model.createPlainLiteral(date);	
		//Node dateNode = new DatatypeLiteralImpl(year, XSD._date); 
	    Statement stm = model.createStatement(this, PROV_GENERATEDATTIME, dateNode);
	    model.addStatement(stm); //name
	}
	
	public void addInDataset(Model model, String uriString) {
		Node uriNode = model.createURI(uriString);
		Statement stm = model.createStatement(this, VOID_IN_DATASET, uriNode);
	    model.addStatement(stm); //dataset
	}
	
	public void addScienceCommonPmid (Model model, String uriString) {
		Node uriNode = model.createURI(uriString);
		Statement stm = model.createStatement(this, SCIENCECOMMONS_IDBYPMID, uriNode);
	    model.addStatement(stm); //pmc
	}
